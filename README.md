...
- **V3** - Industrial product layer (AI agents, collaboration, marketplace, tenancy, audit).
  ...
  - **V3.4** - In development: plugin marketplace + persistence (signed artifacts, file-based `PluginStore`, install / upgrade / uninstall). See [docs/development/marketplace.md](docs/development/marketplace.md).
